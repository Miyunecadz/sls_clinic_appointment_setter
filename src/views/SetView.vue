...
<template>
    <SidebarComponent>
        <div class="row justify-content-center" style="margin-left:0px;margin-right:0px;margin-top:20px;margin-bottom:20px;">
                ...
                <form action="" method="post">
                    ...
                    <Swiper :slides-per-view="3" :space-between="10">
                        <SwiperSlide v-for="schedule in schedules">
                            <SliderCardComponent :title="schedule.service_type" :time="schedule.time"
                                :date="schedule.date"
