      ...
      <div class="col-md-5 my-auto p-2 p-md-4 bordered">
        <form action="">
          ...
          <div class="form-group my-3">
            <label for="id number">ID Number: {{authUser.id_number ?? authUser.employee_id}}</label>
          ...
          <div class="form-group my-3 d-grid gap-2">
            <RouterLink class="btn btn-success" to="/update-profile">Update Profile</RouterLink>
            <button type="button" class="btn btn-danger" @click.prevent="deleteAccount">
              <div v-if="loadingState" class="spinner-border text-light" role="status" style="max-height:20px;max-width:20px">
