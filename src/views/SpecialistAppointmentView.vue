          ...
          <table class="table ">
            ...
            <tbody class="table-group-divider">
              <tr v-for="appointment in appointments" :key="appointment.id">
                ...
                <td>
                  <div class="d-flex gap-2" v-if="appointment.status == 'pending'">
                    <button type="button" :class="approveLoadingState ? 'disabled': ''" class="btn btn-success" @click="approve(appointment.id)">
                      <div v-if="approveLoadingState" class="spinner-border text-light" role="status"
                    ...
                    <button type="button" :class="rejectLoadingState ? 'disabled': ''" class="btn btn-danger">
                      ...
                      <span>{{ rejectLoadingState ? 'Rejecting...' : 'Reject' }}</span>
                    </button>
                  </div>
                </td>
              </tr>
